  ...
  return (
    <section className="relative bg-midnight-navy text-cloud-white py-20 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-gradient-to-br from-electric-blue/20 to-performance-green/20 filter blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <p className="mt-6 text-lg md:text-xl text-slate-grey max-w-3xl mx-auto font-roboto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          Expert guidance in Stocks, Crypto, and Derivatives with intelligent hedging strategies. We help you <span className="text-performance-green font-semibold">hedge smart</span> and <span className="text-electric-blue font-semibold">trade wise</span>.
        </p>
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <button className="group border-2 border-performance-green text-performance-green px-8 py-4 rounded-lg font-montserrat font-medium hover:bg-performance-green/10 transition-all duration-300 hover:shadow-lg hover:shadow-performance-green/30">
            <span className="flex items-center justify-center">
              Join WhatsApp Community
              <svg className="w-5 h-5 ml-2 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="glass rounded-xl p-6 hover-glow">
            <div className="text-3xl font-bold text-performance-green font-montserrat">10+</div>
            <div className="text-sm text-slate-grey mt-2">Years Experience</div>
          </div>
          <div className="glass rounded-xl p-6 hover-glow">
            <div className="text-3xl font-bold text-electric-blue font-montserrat">500+</div>
            <div className="text-sm text-slate-grey mt-2">Active Clients</div>
          </div>
          <div className="glass rounded-xl p-6 hover-glow">
            <div className="text-3xl font-bold text-performance-green font-montserrat">₹50Cr+</div>
