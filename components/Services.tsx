          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`${service.iconColor} mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
                  {service.icon}
                </div>
                ...
                <p className="text-slate-grey mb-6 text-sm leading-relaxed">{service.description}</p>
                <a href="#" className="inline-flex items-center text-electric-blue font-medium text-sm group-hover:text-performance-green transition-colors duration-300">
                  Learn More
